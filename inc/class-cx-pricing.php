...
$plans = [
    '1_website' => [
        '1_year' => [
            ...
            'mobile_title' => esc_html__("Updated and support for 1 year", "coupon-x"),
        ],
        '2_years' => [
            'price' => 69,
            'month' => 2.9,
            'link' => $proURL."38",
            'title' => esc_html__("2 years", "coupon-x"),
            'mobile_title' => esc_html__("Updated and support for 2 years", "coupon-x"),
        ],
        'lifetime' => [
            'price' => 149,
            'month' => 0,
            ...
            'mobile_title' => esc_html__("Updated and support for lifetime", "coupon-x"),
        ]
    ],
    '5_websites' => [
        '1_year' => [
    ...
    <div class="price-container">
        <div class="plan-details">
            <div class="unlock-features text-center">
                <div class="unlock-features-title"><?php esc_html_e("Unlock all features", "coupon-x"); ?></div>
                <div class="unlock-features-desc"><?php esc_html_e("(enjoy 30-day money back guarantee on all plans)", "coupon-x"); ?></div>
            </div>
            <div class="plan-details-bottom">
                <div class="plan-options">
                    <div class="plan-option active" data-id="1_year">
                        <div class="plan-title"><?php esc_html_e("1 year", "coupon-x"); ?></div>
                        <div class="plan-desc"><?php esc_html_e("Updates & Support", "coupon-x"); ?></div>
                    </div>
                    <div class="plan-option" data-id="2_years">
                        <div class="plan-title"><?php esc_html_e("2 years ", "coupon-x"); ?><span>(32% Off
                    ...
                    <div class="plan-option" data-id="lifetime">
                        <div class="plan-title"><?php esc_html_e("Lifetime ", "coupon-x"); ?><span>(63% Off
                            <svg width="17" height="18" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <rect y="0.712891" width="17" height="17" fill="url(#pattern0)"/>
                                <defs>
                                    <pattern id="pattern0" patternContentUnits="objectBoundingBox" width="1" height="1">
                    ...
                    <div class="pricing-header-top">
                        <div class="plan-row">
                            <div class="plan-col first-col plan-data">
                                <span class="plan-plugin-name">Coupon X</span>
                ...
                foreach($reviews as $review) { ?>
                    <div class="client-testimonial">
                        <div class="client-testimonial-slide">
                            <a href="<?php echo esc_attr($review['profile']) ?>" >
...
<div class="premio-faqs">
    <div class="price-container">
        ...
        <div class="faq-lists">
            ...
            $faqs = [
                [
                    'question' => "How long is my paid Coupon X plugin license valid for?",
                    'answer' => "Once you purchase any paid plan of Coupon X, you can use it forever. Support and updates are available for 1 year. You can renew your license each year to get another year of support and updates."
                ],
                [
                ...
                [
                    'question' => "Can I use Coupon X plugin on more than 1 domain?",
                    'answer' => "There 2 ways to do it:
                        <ul>
                        <li>You can install the free Coupon X plugin on any website you want</li>
                ...
                [
                    'question' => "Will Coupon X stop working if I don’t renew my license?",
                    'answer' => "Of course NOT!<br/>Coupon X plugin and all your settings will continue to work as before; however, you will no longer receive plugin updates including feature additions, improvements, and support."
                ],
            ];
