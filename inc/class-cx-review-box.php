...
class Cx_review_box
{
     ...
     * @access public
     */
    public $pluginSlug = "coupon-x-discount-pop-up";
     ...
     * @access public
     */
    public $wpPluginSlug = "coupon-x-discount-pop-up";
    ...
    /**
     * Add JS/CSS files to the admin page
     *
     * @since  1.0.0
     * @access public
     */
    public function enqueue_scripts()
    {
        if (current_user_can('manage_options')) {
            wp_enqueue_style($this->pluginSlug."-star-rating-svg", plugins_url('../assets/css/star-rating-svg.css', __FILE__), [], COUPON_X_VERSION);
            wp_enqueue_script($this->pluginSlug."-star-rating-svg", plugins_url('../assets/js/jquery.star-rating-svg.min.js', __FILE__), ['jquery'], COUPON_X_VERSION);
        }
    ...
    public function admin_notices()
    {
        ...
        <script>
            (function($) {
                ...
                CxCouponFreeReview.prototype.getSelectors = function() {
                    return {
                        body: 'body',
                ...
                CxCouponFreeReview.prototype.getElements = function() {
                ...
                CxCouponFreeReview.prototype.bindEvents = function() {
                ...
                CxCouponFreeReview.prototype.feedbackFormHandler = function(ev) {
                    ev.preventDefault();
                    const elements  = this.getElements();
                ...
                CxCouponFreeReview.prototype.thankYouDismissHandler = function() {
                    const elements = this.getElements();
                    elements.$reviewBox.remove();
                    elements.$reminderPopup.remove();
                    this.sendHideRequest( -1 );
                ...
                CxCouponFreeReview.prototype.reminderHandler = function(ev) {
                    ev.preventDefault();
                ...
                CxCouponFreeReview.prototype.sendHideRequest = function( dataDays = -1 ) {
                    $.ajax({
                        url: "<?php echo esc_url(admin_url("admin-ajax.php")) ?>",
                ...
                CxCouponFreeReview.prototype.toggleReminderPopup = function( action = true ) {
                    if( action ) {
                ...
                CxCouponFreeReview.prototype.renderRating = function() {
                    const self      = this;
...
$Cx_review_box = new Cx_review_box();
